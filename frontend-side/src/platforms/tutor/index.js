...
export { default as GenarateCode } from './GenarateCode';
export { default as TutorCreateAccount } from './TutorCreateAccount';
export { default as TutorLoginPage } from './TutorLoginPage';
